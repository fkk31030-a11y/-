...
from config import BOT_TOKEN  # ضع توكن البوت هنا
...
data = load_data()
user_states = {}  # حالات المستخدم أثناء إعداد السحب
temp_info = {}    # بيانات مؤقتة أثناء إنشاء السحب
...
def draw_winners(update: Update, context: CallbackContext):
    ...
    q.message.edit_text(msg, parse_mode="MarkdownV2")
